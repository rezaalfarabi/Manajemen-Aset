                    ...
                    @foreach($kategori as $no => $kategori)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('delete-kategori', encrypt($kategori->kategori_id))}}" class="btn btn-danger" onclick="return confirm('Yakin mau dihapus ?')"><i class="fa fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
